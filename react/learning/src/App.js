...
switchNameHandler = () => {
	...
	render() {
		return (
			...
			<Person name={this.state.persons[0].nome} age={this.state.persons[0].idade}/>
			<Person name={this.state.persons[1].nome} age={this.state.persons[1].idade}>e gosto de cavalos</Person>
			</div>
			);
